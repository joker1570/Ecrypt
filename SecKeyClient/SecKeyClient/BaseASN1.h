...
private:
	...
	const ITCAST_UINT8 TRUE ;
	const ITCAST_UINT8 FALSE;
	/* 标记当前数据是原始数据还是编码数据 */
	const ITCAST_UINT32 ITCAST_DER_CONSTRUCTED;
	const ITCAST_UINT32 ITCAST_DER_PRIMITIVE;

	/* The encodings for the universal types */
	const ITCAST_UINT32  ITCAST_DER_UNIVERSAL;
	const ITCAST_UINT32 ITCAST_DER_APPLICATION;
	const ITCAST_UINT32 ITCAST_DER_CONTEXT_SPECIFIC;
	const ITCAST_UINT32 ITCAST_DER_PRIVATE;
	...
	const ITCAST_UINT32 ITCAST_DER_CLASS_MASK;
	const ITCAST_UINT32 ITCAST_DER_CONSTRUCTED_MASK;
	const ITCAST_UINT32 ITCAST_DER_SHORT_ID_MASK;
	const ITCAST_UINT32 ITCAST_DER_FIRST_NOT_ID_MASK ;     //xia
	const ITCAST_UINT32 ITCAST_DER_FIRST_YES_ID_MASK;     //xia
	const ITCAST_UINT32 ITCAST_DER_ALL_YES_ID_MASK ;     //xia
