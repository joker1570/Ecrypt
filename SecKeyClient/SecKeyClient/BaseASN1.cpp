...
BaseASN1::BaseASN1():TRUE(1),FALSE(0),ITCAST_DER_CONSTRUCTED(0x20),ITCAST_DER_PRIMITIVE(0x00),ITCAST_DER_UNIVERSAL(0x00),
	ITCAST_DER_APPLICATION(0x40),ITCAST_DER_CONTEXT_SPECIFIC(0x80),ITCAST_DER_PRIVATE(0xC0),ITCAST_DER_CLASS_MASK(0xC0),
	ITCAST_DER_CONSTRUCTED_MASK(0x20),ITCAST_DER_SHORT_ID_MASK(0x1F),ITCAST_DER_FIRST_NOT_ID_MASK(0x7F),ITCAST_DER_FIRST_YES_ID_MASK(0x80),
	ITCAST_DER_ALL_YES_ID_MASK(0xFF)
{
}
